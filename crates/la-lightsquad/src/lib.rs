...
//!
//! ```rust
//! use la_lightsquad::{Archetype, GateDimension, ToolDescriptor};
//!
...
//! | D-5 | `GateDimension` duplication — SDK has its own 10-variant copy without `Custom` | **RESOLVED** | SDK re-exports `la_lightsquad::GateDimension` |
